		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Movements App",
									"targetURL": "#beapsapmovementsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapsapmovementsapp-display": {
								"semanticObject": "beapsapmovementsapp",
								"action": "display",
								"description": "Fiori application for movements",
								"title": "Movements App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.sap.movementsapp",
									"url": sap.ui.require.toUrl("be/ap/sap/movementsapp")
								}
							}
						}
					}
